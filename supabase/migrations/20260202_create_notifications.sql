-- Smart Migration for Notifications Table
-- Handles cases where the table might already exist from CMS migration
-- Ensures strict type safety and column existence
...
-- Drop existing policies to avoid conflicts significantly
DROP POLICY IF EXISTS "Users can view their own notifications" ON public.notifications;
DROP POLICY IF EXISTS "Users can view relevant notifications" ON public.notifications; -- Drop legacy name if exists
