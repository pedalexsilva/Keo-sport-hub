            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="lg:flex items-center">
                    <div className="lg:w-1/2 mb-10 lg:mb-0">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6">Your health in the palm of your hand.</h2>
                        <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                            Access the KEO event calendar, track your progress, earn points, and exchange them for exclusive company benefits.
                        </p>
                            ...
                            <div className="w-full h-full bg-white text-gray-800 overflow-y-auto no-scrollbar">
                                ...
                                <div className="bg-[#002D72] p-6 text-white pt-12 rounded-b-3xl">
                                    <div className="flex justify-between items-center mb-4">
                                        <div>
                                            <p className="text-xs text-blue-200">Hello, Miguel</p>
                                    ...
                                    <div className="bg-white/10 p-4 rounded-xl backdrop-blur-md">
                                        <p className="text-xs text-blue-200 mb-1">Steps Today</p>
                                        <p className="text-3xl font-bold">8,432</p>
                                    </div>
                                </div>
                                <div className="p-4 space-y-4">
                                    <p className="font-bold text-gray-800">Next Challenge</p>
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                        <div className="bg-orange-100 p-3 rounded-lg text-orange-600"><Flame className="w-5 h-5" /></div>
                                        <div>
                                            <p className="font-bold text-sm">Running Week</p>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                        ...
                                        <div>
                                            <p className="font-bold text-sm">Padel Tournament</p>
